    ...
    >
      <div class="container">
        <div class="row m0 center-xs between-md footer-link-bar">
          ...
          <div class="row m0 col-xs-12 col-sm-3">
            <h5>{{ $t('Information and Support') }}</h5>
            <!-- BEGIN CMS BLOK -->
            <ul>
              <li><a href="#">Veel gestelde vragen</a></li>
              <li><a href="#">Acties</a></li>
          ...
          <div class="row m0 col-xs-12 col-sm-3">
            ...
            <!-- BEGIN CMS BLOK -->
            <p>Kappersmagazijn.nl<br>
              Zeewinde 5<br>
              9738 AM Groningen
            </p>
            <p>T: <a href="tel:+31123456">050 364 23 77</a><br>
              E: kappersmagazijn@gmail.com
            </p>
        ...
        <div class="row social mt30">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="facebook icon" width="40" height="40" viewBox="0 0 40 40"
                 fill="#BDBDBD">
              <path
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="instagram icon" width="40" height="40" viewBox="0 0 40 40"
                 fill="#BDBDBD">
              <path
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="pinterest icon" width="40" height="40" viewBox="0 0 40 40"
                   fill="#BDBDBD">
                <path
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="youtube icon" width="40" height="40" viewBox="0 0 40 40"
                   fill="#BDBDBD">
                <path
        ...
        <div class="row pt20 mt20 center-xs footer-copyright-bar">
          <div class="col-sm-2 col-xs-12 last-sm mt20 social-icons">
            <a
              class="social-icon mx5 brdr-circle no-underline"
              href="https://www.facebook.com/"
              :aria-label="$t('Go to Facebook')"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="facebook icon" width="24" height="24" viewBox="0 0 40 40"
                   fill="">
                <path
                  d="M20,0 C8.9541,0 0,8.95435 0,20 C0,31.0457 8.9541,40 20,40 C31.0459,40 40,31.0457 40,20 C40,8.95435 31.0459,0 20,0 Z M22.085,20.8785 L22.085,31.7595 L17.5825,31.7595 L17.5825,20.8789 L15.3335,20.8789 L15.3335,17.1293 L17.5825,17.1293 L17.5825,14.8779 C17.5825,11.819 18.8525,10 22.4609,10 L25.4653,10 L25.4653,13.7501 L23.5874,13.7501 C22.1826,13.7501 22.0898,14.2742 22.0898,15.2521 L22.085,17.1288 L25.4863,17.1288 L25.0884,20.8785 L22.085,20.8785 Z"/>
              </svg>
            ...
            <a
              ...
              :aria-label="$t('Go to Instagram')"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="instagram icon" width="24" height="24" viewBox="0 0 40 40"
                   fill="#BDBDBD">
                <path
                  d="M20,0 C8.9541,0 0,8.95435 0,20 C0,31.0457 8.9541,40 20,40 C31.0459,40 40,31.0457 40,20 C40,8.95435 31.0459,0 20,0 Z M15.603,9.39783 C16.7407,9.34607 17.104,9.33337 20.001,9.33337 C22.8955,9.33337 23.2578,9.34607 24.3955,9.39783 C25.5312,9.44983 26.3066,9.62964 26.9868,9.89343 C27.689,10.1656 28.2822,10.53 28.8755,11.1234 C29.4692,11.7163 29.8335,12.3114 30.1069,13.0129 C30.3691,13.6912 30.5488,14.4663 30.6025,15.6019 C30.6533,16.7396 30.667,17.1033 30.667,20.0001 C30.667,22.8971 30.6533,23.2598 30.6025,24.3976 C30.5488,25.5327 30.3691,26.308 30.1069,26.9865 C29.8335,27.6877 29.4692,28.283 28.8755,28.8759 C28.2832,29.4691 27.689,29.8345 26.9873,30.1069 C26.3086,30.3707 25.5327,30.5505 24.397,30.6025 C23.2593,30.6543 22.897,30.6669 20,30.6669 C17.103,30.6669 16.7397,30.6543 15.6021,30.6025 C14.4668,30.5505 13.6914,30.3707 13.0127,30.1069 C12.3115,29.8345 11.7163,29.4691 11.1235,28.8759 C10.5308,28.283 10.166,27.6877 9.89355,26.9862 C9.62988,26.308 9.4502,25.5328 9.39795,24.3973 C9.34619,23.2595 9.3335,22.8971 9.3335,20.0001 C9.3335,17.1033 9.34668,16.7395 9.39795,15.6017 C9.44873,14.4666 9.62891,13.6912 9.89307,13.0127 C10.1665,12.3114 10.5312,11.7163 11.1245,11.1234 C11.7173,10.5303 12.3125,10.1658 13.0142,9.89343 C13.6924,9.62964 14.4673,9.44983 15.603,9.39783 Z"/>
                <path
            ...
            <a
              class="social-icon mx10 brdr-circle no-underline"
              href="https://www.pinterest.com"
              :aria-label="$t('Go to Whatsapp')"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="pinterest icon" width="24" height="24" viewBox="0 0 40 40"
                   fill="#BDBDBD">
                <path
                  d="M0,19.9989 C0,31.0437 8.95264,40 20,40 C31.0454,40 40,31.0437 40,19.9989 C40,8.9541 31.0454,0 20,0 C8.95264,0 0,8.9541 0,19.9989 Z M13.3696,36.8771 C6.62793,34.2357 1.85059,27.6766 1.85059,19.9991 C1.85059,9.98682 9.96533,1.87463 19.9761,1.87463 C29.9868,1.87463 38.1016,9.98682 38.1016,19.9991 C38.1016,30.0094 29.9868,38.1238 19.9761,38.1238 C18.106,38.1238 16.3042,37.8409 14.6099,37.314 C15.3467,36.1101 16.4521,34.1372 16.8613,32.5627 C17.082,31.7145 17.9902,28.255 17.9902,28.255 C18.5815,29.3817 20.3081,30.3372 22.146,30.3372 C27.6108,30.3372 31.5508,25.3096 31.5508,19.0631 C31.5508,13.0758 26.6641,8.59448 20.3765,8.59448 C12.5552,8.59448 8.40137,13.847 8.40137,19.5643 C8.40137,22.2206 9.81543,25.5323 12.0776,26.5862 C12.4224,26.7448 12.6069,26.6741 12.686,26.342 L12.8516,25.6682 C12.9653,25.2057 13.1074,24.6292 13.1895,24.2877 C13.2324,24.1035 13.2109,23.9471 13.063,23.7672 C12.3135,22.8589 11.7158,21.1881 11.7158,19.6307 C11.7158,15.6335 14.7427,11.7649 19.8989,11.7649 C24.3525,11.7649 27.4697,14.7981 27.4697,19.1381 C27.4697,24.0414 24.9932,27.4388 21.7715,27.4388 C19.9932,27.4388 18.6606,25.9694 19.0869,24.1635 C19.272,23.3851 19.519,22.5848 19.7598,21.8065 C20.1851,20.4301 20.5889,19.1227 20.5889,18.1292 C20.5889,16.7367 19.8413,15.5757 18.2964,15.5757 C16.4756,15.5757 15.0166,17.4564 15.0166,19.9778 C15.0166,21.5823 15.5586,22.6683 15.5586,22.6683 C15.5586,22.6683 13.7612,30.2621 13.4336,31.6759 C13.0693,33.244 13.2109,35.444 13.3696,36.8771 Z"/>
              </svg>
          ...
          <div class="col-xs-12 col-sm-2 last-xs first-sm mt20 payment-icons">
            <i class="icon social-icon">iDealL</i>
            <i class="icon social-icon">CC</i>
            <i class="icon social-icon">PP</i>
          </div>
          <div class="col-sm-8 first-xs bottom-links">
            <ul class="links px0" data-testid="bottomLinks">
              <li class="center">
                <router-link :to="getLinkFor('/terms-and-condition')" exact>
                  {{ $t('Terms and condition') }}
                </router-link>
              </li>

              <li class="center">
                <router-link :to="getLinkFor('/privacy')" exact>
                  {{ $t('Privacy statement') }}
                </router-link>
              </li>

              <li class="center">
                <router-link :to="getLinkFor('/cookies')" exact>
                  {{ $t('Cookies') }}
                </router-link>
              </li>

              <li class="center">
                <router-link :to="getLinkFor('/sitemap')" exact>
                  {{ $t('Sitemap') }}
                </router-link>
              </li>

              <li class="inline-flex">
                &copy; 2010-{{ new Date().getFullYear() }} Winkelnaam moet nog
              </li>
            </ul>
          </div>
        </div>
