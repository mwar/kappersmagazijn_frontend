<template>
  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckoutPage }">
    <section class="footer-contact" v-if="!isCheckoutPage">
      <div class="container">
        <div class="row">
          <!-- TODO nieuwsbrief -->
          ...
          <footer-contact-icon
            class="col-xs-12 col-md-3"
            title="E-mail ons"
            description="Stel hier je vraag"
            url="/contact"
          ...
          <footer-contact-icon
            class="col-xs-12 col-md-3"
            title="WhatsApp ons"
            description="Klik hier om ons een berichtje te sturen."
            url="/contact"
            icon="/assets/icons/search-regular.svg"
            type="whatsapp"
          />
